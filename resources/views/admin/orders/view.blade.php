        ...
        <div class="col-md-12">
            <div class="card" style="background-color:#F4F5F5;">
                <div class="card-header" style="background-color: #2D2F32;color:white;">
                    <h4 style="color: white">Orders View
                    <a href="{{url('/orders')}}"><button class="btn btn-light" style="float: right">Back</button></a>
                    </h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-5 order-details" style="color: black">
                        ...
                        <div class="col-md-6">
                    <table class="table table-bordered" style="border: 1px solid #D0D0D0;color:black">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Quantity</th>
